...
const updateAdyenOrderInfo = async (access_token, orderNo, paymenInstrumentId, adyenInfo) => {
    ...
    const result = await fetch(`${getAppOrigin()}/mobify/proxy/api/checkout/orders/v1/organizations/f_ecom_bgfs_001/orders/${orderNo}/payment-instruments/${paymenInstrumentId}/transaction?siteId=RefArch`, {
        method: 'PATCH',
        headers: {
